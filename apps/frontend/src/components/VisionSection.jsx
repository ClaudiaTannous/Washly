  ...
  return (
    <section className="py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl mb-6 text-gray-900">Our Mission</h2>
        ...
        <div className="grid md:grid-cols-3 gap-10 mt-16">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl mb-3 text-gray-900">Customer First</h3>
            <p className="text-gray-600 leading-relaxed text-sm">
              Your satisfaction drives everything we do. We're committed to
              delivering quality service that exceeds expectations, every single
              time.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl mb-3 text-gray-900">Eco-Conscious</h3>
            <p className="text-gray-600 leading-relaxed text-sm">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl mb-3 text-gray-900">Community Focused</h3>
            <p className="text-gray-600 leading-relaxed text-sm">
